 ...
 *
 * This class works in conjunction with ApiClient to send requests and receive API responses.
 *
 * Usage example:
 * <pre>
 * ApiRequestBuilder builder = new ApiRequestBuilder(apiClient, HttpMethod.POST, "/users");
...
public class ApiRequestBuilder {
    ...
    /**
     * Constructs an ApiRequestBuilder with the given ApiClient, HTTP method, and endpoint.
     *
     * @param apiClient the ApiClient used to execute the request
