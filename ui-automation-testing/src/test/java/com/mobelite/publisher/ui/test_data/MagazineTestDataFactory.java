...
public class MagazineTestDataFactory {
    ...
    public static MagazineRequest createMagazineRequest(String title, int issueNumber, LocalDate publicationDate, List<Integer> authorIds) {
    ...
    public static MagazineRequest createValidMagazineRequest(List<Integer> authorIds) {
    ...
    public static MagazineRequest createStaticMagazineRequest(List<Integer> authorIds) {
